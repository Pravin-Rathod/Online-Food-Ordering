                ...
                <div class="col-12 ">
                    <form action="login.php" method="POST" >
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" type="tel" placeholder="Enter Mobile No." required="required" name="mobile" autofocus="">
                        </div>
                        <br>
                        
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-key fa-fw" aria-hidden="true"></i></span>
                            <input class="form-control" type="password" placeholder="Enter Password" required="required" name="password">
                        </div>
                        <br>
                        <button class="btn btn-lg btn-primary btn-block" type="submit" name="signin">Sign in</button>
                    </form>
                    <br>
                    <a href="index.html"> <button class="btn btn-lg btn-primary btn-block" type="submit" name="signin">Not Registered ?</button></a>
